 ...
 * @package Skeleton\Core\Middleware
 */
class AuthMiddleware
{
...
//        if (preg_match("/\/student\//", $path)) {
//            return $next($request, $response);
//        }

        if (!$this->loggedIn() && !in_array($path, $this->aclData[self::GUEST_LEVEL]) && !preg_match("/\/student\//", $path)) {
